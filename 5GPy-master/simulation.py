...
'''
	#função resaponsavel pela geração de dados pelo sensores
    def	DataGeneration():
        pass
	#função resaponsavel pela coleta de dados pelo sensores
    def DataReceive():
        BangladeshData = pd.read_csv('Agricultural.csv')
		
        temperature_max = BangladeshData['max_temperature']
        temperature_min = BangladeshData['min_temperature']       
        temperature_avg = temperature_max + temperature_min / 71
        humidity = BangladeshData['humidity']
        soil_moisture = BangladeshData['soil moisture']

        # extractedInformations = []
        # for information in extractedInformations:
        #     extractedInformations.append(information)
        # print(extractedInformations)
class aggregator():
	pass
'''